        ...
        <section className="py-24 px-6 bg-gradient-to-b from-slate-50 to-slate-100">
            ...
            <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
                ...
                <motion.div
                    ...
                    className="bg-white p-8 rounded-2xl shadow-md border-t-4 border-blue-800 hover:shadow-xl transition"
                >
                    <div className="w-14 h-14 flex items-center justify-center rounded-full bg-blue-100 mb-5">
                        {/* SVG ICON */}
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-blue-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    whileHover={{ scale: 1.03 }}
                    className="bg-white p-8 rounded-2xl shadow-md border-t-4 border-orange-500 hover:shadow-xl transition"
                >
                    <div className="w-14 h-14 flex items-center justify-center rounded-full bg-orange-100 mb-5">
                        {/* SVG ICON */}
